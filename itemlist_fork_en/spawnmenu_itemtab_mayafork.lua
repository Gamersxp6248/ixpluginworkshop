...
if SERVER then
    ...
    local function OpenItemCleanPopup(item)
        ...
        label:SetText("Are you sure you want to delete every copy of this item?\n\n" ..
            "This will clean out all versions of this item from:\n" ..
        ...
        yesBtn:SetText("Yes, destroy all copies of this item.")
        ...
        noBtn:SetText("No, I clicked this by mistake.")
    ...
    spawnmenu.AddContentType("item", function(panel, data)
        ...
        function icon:OpenMenu()
            ...
            local debugOption = menu:AddOption("Print Debugging", function()
		...
		print("-- End of Item Debug Block --")
            ...
            local teleportOption = menu:AddOption("Teleport To", function()
            ...
            local cleanOption = menu:AddOption("Destroy All", function()
